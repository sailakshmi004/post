...
//     try {
//       await axios.delete(`http://localhost:8000/art/${id}`);
...
//     try {
//       await axios.put(`http://localhost:8000/art/${id}`, updatedData);
...
//     <h1 className="text-center" style={{fontFamily:'sans-serif'  ,fontSize: '3rem', fontWeight: 'bold', marginBottom: '1rem' }}>Articles</h1>
